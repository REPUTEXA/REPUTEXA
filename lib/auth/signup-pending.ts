...
/** Anciennes sessions pouvaient inclure `password` (fallback confirm-email) — retiré du flux nominal. */
...
/** Supprime les identifiants en attente sans les consommer (nouvelle inscription / reset navigateur). */
