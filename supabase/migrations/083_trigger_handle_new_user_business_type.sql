-- Migration 083 : handle_new_user inclut business_type dès l'inscription
-- Permet de remplir profiles.business_type depuis raw_user_meta_data au moment
-- de la création du compte (trial ET checkout).
...
BEGIN
  ...
  -- Récupérer metadata : formulaire inscription OU Google OAuth
  ...
  -- Valider business_type : seuls 'physical' et 'online' sont acceptés
