        ...
        <div className="p-3 sm:p-4 md:p-5 lg:p-6 bg-white space-y-4 max-h-[75vh] overflow-y-auto">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-slate-900">
                  L&apos;IA a détecté {securityAlerts} avis négatif{securityAlerts > 1 ? 's' : ''} sur la période affichée
                </p>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-4 sm:p-5">
              <div className="mb-4">
                <h3 className="font-display font-semibold text-slate-900">Avis par plateforme</h3>
          ...
          <DashboardReviewsSection reviews={reviews} useSupabaseAuth={false} />
        </div>
      </div>
    </div>
  );
