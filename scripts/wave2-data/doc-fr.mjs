export const documentationPageFr = {
  ...
  flowTitle: 'Flux de traitement automatique',
  flowIntro:
  ...
  whatsappFlow: [
    {
      ...
      detail:
        'Un client laisse un avis ≤ 3 étoiles sur Google, Facebook ou Trustpilot.',
    },
    {
    ...
    },
    {
      ...
      detail:
        "Une réponse contextualisée est générée automatiquement, respectant votre ADN IA configuré.",
    },
    {
  ...
  platformsFootnote:
    "La connexion Google utilise uniquement l'autorisation <code>business.manage</code> — aucun accès à votre compte Google personnel.",
  posTitle: 'Intégration POS & Zapier',
  posBadge: 'Exclusif ZENITH',
  posIntro:
    "REPUTEXA génère une clé d'API d'entrée (<rtx>rtx_live_…</rtx>) visible dans vos Paramètres. Elle permet à vos systèmes externes (logiciel de caisse, Zapier, Make) d'envoyer des données de visite à REPUTEXA, qui déclenche automatiquement le module AI Capture — un message WhatsApp envoyé au client 30 minutes après sa visite pour l'inviter à laisser un avis.",
  posCodeLabel: 'Webhook entrant — données de visite POS',
  posSnippet: `POST https://reputexa.fr/api/webhooks/{votre_cle_rtx_live}
...
// Fonctionnalité exclusive ZENITH (AI Capture).`,
  posNote:
    "Cette clé est pour les <strong>webhooks entrants</strong> (données vers REPUTEXA). Elle n'est pas utilisée pour lire vos avis ou vos statistiques via une API externe.",
